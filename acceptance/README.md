...
What it does not cover: files GDAL did not write, which the next section
takes on; compressions the reader refuses (JPEG, WebP, LERC); reading
over HTTP; and decode speed, which nothing here measures yet.
