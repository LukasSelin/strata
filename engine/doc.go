...
// (DESIGN.md §15–17). This version runs on the calling goroutine; tiles
...
// rectangle is the natural unit at every level of DESIGN.md §5.1's
...
// (DESIGN.md §20): a fused pipeline is a single kernel whose inputs are
...
// edge. Kernels never implement boundary logic (DESIGN.md §16). The edge
...
// pools nothing (DESIGN.md §26). Kernels should not allocate in Process
