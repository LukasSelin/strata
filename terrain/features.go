...
// OrientationOptions, CurvatureOptions and RuggednessOptions, each meaning
// what it means to its own function; no other type can implement it.
...
func (o OrientationOptions) featureKernel() exec.Kernel { return orientationOp(o) }
...
// it: any mix of Slope, Aspect, Hillshade, HeatLoad, Orientation,
// Curvature and Ruggedness, each with its own options, so the same measure can be taken at several
